...
def Bottleneck_25(input_tensor,filters=8,attention_module='cbam_block'):
...
def lambda_25(input_tensor,attention_module='cbam_block'):
    ...
    #shuffle
    assert features._keras_shape[-1]==32*25
    random_list=np.random.permutation(32*25)
    shuffle_features=[]
